...
const _SplitText = class _SplitText {
    ...
    constructor(elements, config){
        ...
        this.elements.forEach((el)=>{
            var _a;
            config.overwrite !== false && ((_a = el[_splitProp]) == null ? void 0 : _a._data.orig.filter((param)=>{
                let { element } = param;
                return element === el;
...
//# sourceMappingURL=node_modules_gsap_9ea637d3._.js.map